                        ...
                        <div class="col mb-4 mb-xl-0">
                            <div class="table-responsive mb-4 mb-xl-0">
                                <table class="table  table-flush">                                    
                                    ...
                                    <button type="button" class="btn btn-default btn-lg btn-block">1. Valor do investimento</button>
                                </table> 
                                <br>
                                ...
                                <button type="button" class="btn btn-default btn-lg btn-block">2. Dados cadastrais</button>
